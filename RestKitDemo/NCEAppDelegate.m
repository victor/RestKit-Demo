...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NCEMasterViewController *masterViewController = [[[NCEMasterViewController alloc] initWithNibName:@"NCEMasterViewController" bundle:nil] autorelease];
    UINavigationController *masterNavigationController = [[[UINavigationController alloc] initWithRootViewController:masterViewController] autorelease];

    NCEDetailViewController *detailViewController = [[[NCEDetailViewController alloc] initWithNibName:@"NCEDetailViewController" bundle:nil] autorelease];
